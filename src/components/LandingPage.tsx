  ...
  return (
    <div className="min-h-screen bg-white text-slate-900 dark:bg-slate-950 dark:text-slate-100">
      ...
      <section id="android-app" className="border-y border-slate-100 bg-slate-50 py-16 dark:border-slate-800 dark:bg-slate-900/40">
        <div className="mx-auto max-w-6xl px-5">
          <div className="grid gap-8 rounded-[2rem] bg-slate-950 p-7 text-white shadow-2xl sm:p-10 lg:grid-cols-[1.05fr_.95fr] lg:items-center">
            <div>
              <span className="inline-flex rounded-full border border-blue-400/20 bg-blue-400/10 px-3 py-1 text-[11px] font-bold uppercase tracking-[0.18em] text-blue-300">
                Native Android · Direct Download
              </span>
              ...
              <div className="mt-6 grid gap-2 text-xs text-slate-300 sm:grid-cols-2">
                ...
                <span>✓ Native foreground GPS</span>
                <span>✓ Screen-lock/minimize tracking</span>
                <span>✓ Duty IN → OUT privacy boundary</span>
              </div>
              <p className="mt-5 text-[11px] leading-5 text-slate-500">
                Normal Android security prompts still apply when installing an APK outside Google Play.
              </p>
            </div>
